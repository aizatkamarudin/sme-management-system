											...
											<form id="kt_account_profile_details_form" class="form">
												...
												<div class="card-body border-top p-9">
													...
													<div class="row mb-6">
														...
														<div class="col-lg-8 fv-row">
															<!--begin::Input-->
															<select name="device"  data-control="select2" data-placeholder="Select a Type of Device..." class="form-select form-select-solid form-select-lg">
																<option value="">Select a Device...</option>
																@foreach ($typeDevices as $typeDevice)
																<option value="{{ $typeDevice->id }}" >{{$typeDevice->type_devices}}</option>
																@endforeach
															</select>
														</div>
														<!--end::Col-->
													...
													<div class="row mb-6">
														...
														<div class="col-lg-8 fv-row">
															<!--begin::Input-->
															<select name="category" aria-label="Select a Language" data-control="select2" data-placeholder="Select a Category of Item..." class="form-select form-select-solid form-select-lg">
													...
													<div class="row mb-6">
														...
														<div class="col-lg-8 fv-row">
															<!--begin::Input-->
															<select name="condition"  data-control="select2" data-placeholder="Select a Condition of Item..." class="form-select form-select-solid form-select-lg">
																<option value="">Select a Brand...</option>
