										...
										<div class="card card-flush h-xl-100">
											...
											<div class="card-header pt-7">
												...
												<h3 class="card-title align-items-start flex-column">
													...
													<span class="text-gray-400 mt-1 fw-bold fs-6">{{$inventories->count()}} {{$inventories->count()>1 ?' Items' : 'Item'}}  </span>
												</h3>
												<!--end::Title-->
												<!--begin::Actions-->
												...
												<table class="table align-middle table-row-dashed fs-6 gy-3" >
													...
													<tbody class="fw-bolder text-gray-600">
														...
														<tr>
															...
															<td class="text-end">
																<span class="badge py-3 px-4 fs-7 badge-light-success">{{$inventory->getCategory->category }}</span>
															</td>
															<td class="text-end">
															...
															<td>
																	<div class="d-flex justify-content-end flex-shrink-0">
																		<a href="{{ route('inventory.show', $inventory->id) }}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
																		...
																		<a href="{{ route('inventory.edit', $inventory->id) }}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
