...
<div class="row gy-5 g-xl-10">
									...
									<div class="card-body p-9">
										...
										<div class="row mb-7">
											...
											<!--begin::Col-->
											<div class="col-lg-8">
												<a href="#" class="fw-bold fs-6 text-gray-800 text-hover-primary">{{$inventory->getBrand->model}}</a>
											</div>
											<!--end::Col-->
										</div>
										<div class="row mb-7">
											...
											<!--begin::Col-->
											<div class="col-lg-8">
												<a href="#" class="fw-bold fs-6 text-gray-800 text-hover-primary">{{$inventory->getBrand->getType->type_devices}}</a>
											</div>
											<!--end::Col-->
										</div>
										<!--end::Row-->
