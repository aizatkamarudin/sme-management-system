...
<head>
    <base href="">
    <title>Persiskom Inventory</title>
    <meta charset="utf-8" />
            ...
            <div id="kt_aside" class="aside aside-dark aside-hoverable" data-kt-drawer="true"
                    ...
                    <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
                        ...
                        <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                            ...
                            <div data-kt-menu-trigger="click"
                                class="menu-item menu-accordion @if (request()->segment(1) == 'inventory') here show @endif">
                                <span class="menu-link">
                                    <span class="menu-icon">
                                ...
                                <div class="menu-sub menu-sub-accordion menu-active-bg">
                                    <div class="menu-item">
                                        <a class="menu-link @if (request()->segment(1) == 'inventory' && request()->segment(2) == 'list') active @endif"
                                            href="{{ route('inventory.index') }}">
                                            <span class="menu-bullet">
                                                <span class="bullet bullet-dot"></span>
                                            </span>
                                            <span class="menu-title">List of Inventory</span>
                                        </a>
                                    </div>
                                    <div class="menu-item">
                                        <a class="menu-link" href="../../demo1/dist/pages/about.html">
                                            ...
                                            <span class="menu-title">Inventory Log</span>
                                        </a>
                                    </div>
                                    <div class="menu-item">
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link" href="../../demo1/dist/pages/contact.html">
                                            ...
                                            <span class="menu-title">Low Stock Items</span>
                                        </a>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="menu-sub menu-sub-accordion menu-active-bg">
                                    <div class="menu-item">
                                        <a class="menu-link" href="../../demo1/dist/account/overview.html">
                                            ...
                                            <span class="menu-title">List of Item</span>
                                        </a>
                                    </div>
                                    <div class="menu-item">
                                        <a class="menu-link" href="../../demo1/dist/account/settings.html">
                                            ...
                                            <span class="menu-title">Category of Item</span>
                                        </a>
                                    </div>
                                    <div class="menu-item">
                            ...
                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                <span class="menu-link">
                                    ...
                                    <span class="menu-title">Configuration Management</span>
                                    <span class="menu-arrow"></span>
                                </span>
                                <div class="menu-sub menu-sub-accordion menu-active-bg">
                                    <div class="menu-item">
                                        <a class="menu-link" href="{{ route('brand.index') }}">
                                            ...
                                            <span class="menu-title">Brand Configuration</span>
                                        </a>
                                    </div>
                                    <div class="menu-item">
                                        <a class="menu-link" href="{{ route('typeDevice.index') }}">
                                            <span class="menu-bullet">
                                                <span class="bullet bullet-dot"></span>
                                            </span>
                                            <span class="menu-title">Device Type Configuration</span>
                                        </a>
                                    </div>
                                    <div class="menu-item">
                                        <a class="menu-link" href="../../demo1/dist/account/security.html">
                                ...
                                <div class="menu-sub menu-sub-accordion menu-active-bg">
                                    <div class="menu-item">
                                        <a class="menu-link"
                                            ...
                                            <span class="menu-title">List of Roles</span>
                                        </a>
                                    </div>
                                    <div class="menu-item">
                                        <a class="menu-link"
                ...
                <div class="aside-footer flex-column-auto pt-5 pb-7 px-5" id="kt_aside_footer">
                    <a href="../../demo1/dist/documentation/getting-started.html"
                        ...
                        data-bs-dismiss-="click" title="Settings & Details of Your Account">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/communication/com013.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                ...
                                <div class="header-menu align-items-stretch" data-kt-drawer="true"
                                    ...
                                    <div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-5 my-lg-0 align-items-stretch"
                                        ...
                                        <div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start"
                                            ...
                                            <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">List of
                                                Inventory
                                        </div>
                                    </div>
                                    <!--end::Menu-->
