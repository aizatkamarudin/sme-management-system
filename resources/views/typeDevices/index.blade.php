    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                ...
                <a href="{{ route('typeDevice.create') }}" class="btn btn-sm btn-primary"
            ...
            <div class="card card-flush h-xl-100">
                ...
                <div class="card-header pt-7">
                    ...
                    <h3 class="card-title align-items-start flex-column">
                        ...
                        <span class="card-label fw-bolder text-dark">Existing Type of Devices</span>
                        <span class="text-gray-400 mt-1 fw-bold fs-6">{{ $typeDevices->count() }}
                            {{ $typeDevices->count() > 1 ? ' Items' : 'Item' }} </span>
                    </h3>
                    <!--end::Title-->
                    <!--begin::Actions-->
                        ...
                        <tbody class="fw-bolder text-gray-600">
                            ...
                            @foreach ($typeDevices as $key => $typeDevice)
                                <tr>
                                    ...
                                    <td class="text-start">{{ $typeDevice->type_devices }}</td>

                                    <td>
                                        <div class="d-flex justify-content-end flex-shrink-0">
                                            <a href="{{ route('typeDevice.destroy', $typeDevice) }}"
